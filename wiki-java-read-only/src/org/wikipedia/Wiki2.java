/**
 *  Kann nun auch die PageID ermitteln.
 * 
 ...
 *  @version 0.26
 */
public class Wiki2 implements Serializable
{
    // NAMESPACES
     ...
     *  @since 0.14
     */
    public Wiki2(String domain, String scriptPath)
    {
        this.domain = domain;
    ...
    {
        if (!(obj instanceof Wiki2))
            return false;
        return domain.equals(((Wiki2)obj).domain);
    }
    ...
    public HashMap<String, Object> getPageInfo(String page) throws IOException
    {
        ...
        if (exists)
        {
            try{
                ...
                a = line.indexOf("ns=\"") + 4;
                b = line.indexOf('\"', a);
                info.put("ns", Integer.parseInt(line.substring(a, b)));
    ...
    public class User implements Cloneable
    {
        ...
        {
            return Wiki2.this.contribs(username, ns);
        }
    ...
    public class LogEntry implements Comparable<LogEntry>
    {
         ...
         *  @since 0.18
         */
        public int compareTo(Wiki2.LogEntry other)
        {
    ...
    public class Revision implements Comparable<Revision>
    {
        ...
        public int hashCode()
        {
            return (int)revid * 2 - Wiki2.this.hashCode();
        }
         ...
         *  @since 0.18
         */
        public int compareTo(Wiki2.Revision other)
        {
            if (timestamp.equals(other.timestamp))
                return 0; // might not happen, but
            return timestamp.after(other.timestamp) ? 1 : -1;
        ...
        {
            Wiki2.this.rollback(this, false, "");
        }
        ...
        {
            Wiki2.this.rollback(this, bot, reason);
        }
    }
